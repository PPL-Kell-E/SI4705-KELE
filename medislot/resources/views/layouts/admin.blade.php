...
<head>
    ...
    <title>@yield('title', 'Admin - MEDISLOT')</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-logo-text .logo-name { color: #fff; font-size: 18px; font-weight: 700; letter-spacing: 0.5px; line-height: 1.1; }
        .sidebar-logo-text .logo-role { color: rgba(255,255,255,0.55); font-size: 11px; font-weight: 500; letter-spacing: 1px; text-transform: uppercase; }
        ...
        .sidebar-footer button {
            ...
            color: #e74c3c; font-size: 13.5px; font-weight: 500; font-family: inherit;
        ...
        .topbar-avatar {
            width: 36px; height: 36px; background: #e05252;
...
<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <div class="sidebar-logo-text">
            <span class="logo-name">MEDISLOT</span>

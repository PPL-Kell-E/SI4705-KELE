...
<head>
    ...
    <title>@yield('title', 'Medislot - Janji Temu Medis')</title>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/medislot.css') }}">
...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <a href="{{ route('schedules.index') }}" class="nav-item active"><i class="fas fa-calendar-alt"></i> Jadwal Saya</a>
    ...
    <script src="{{ asset('js/medislot.js') }}"></script>
    @stack('scripts')
</body>
</html>
